...
class StickyGroupedListView<T, E> extends StatefulWidget {
  ...
  final Function(bool bottomReached)? onScrollEnd;
  ...
  const StickyGroupedListView({
    ...
    this.sort = true, required this.onScroll,
...
class GroupedItemScrollController extends ItemScrollController {
  ...
  int indexOfElement(String identifier) {
    return _findIndexByIdentifier(identifier);
  }
