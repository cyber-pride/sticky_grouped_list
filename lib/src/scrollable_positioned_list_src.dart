...
class ScrollablePositionedList extends StatefulWidget {
  ...
  final Function(bool isBottomReached)? onScrollEnd;
  final Function(ScrollPosition scrollPosition) onScroll;
...
class _ScrollablePositionedListState extends State<ScrollablePositionedList>
  ...
  void initState() {
    ...
    secondary.scrollController.addListener(() {
      widget.onScroll.call(primary.scrollController.position);
      if (primary.scrollController.position.pixels == primary.scrollController.position.maxScrollExtent) {
        widget.onScrollEnd?.call(true);
      }
      if (primary.scrollController.position.pixels == primary.scrollController.position.minScrollExtent) {
